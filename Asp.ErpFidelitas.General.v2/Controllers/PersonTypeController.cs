...
namespace Asp.ErpFidelitas.General.v2.Controllers
{
    ...
    {
        PersonType personT;
        List<PersonType> personTip;
        Response responseClient;
        const string UrlActionPathDetails = "https://localhost:44331/General/PersonsType/ObtenerUno?id={0}";
        const string UrlActionPathList = "https://localhost:44331/General/PersonsType/ObtenerTodas";
        const string UrlActionPathInsertOne = "https://localhost:44331/General/PersonsType/CrearUno";
        const string UrlActionPathUpdate = "https://localhost:44331/General/PersonsType/ActualizarUno";
        const string UrlActionPathDelete = "https://localhost:44331/General/PersonsType/BorrarUno?id={0}";

        // GET: PersonType
        public async Task<ActionResult> Index()
        {
            personTip = new List<PersonType>();
            ...
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    {
                        personTip = JsonConvert.DeserializeObject<List<PersonType>>(responseClient.Value.ToString());
                    }
                }
            }
            ...
            return View(personTip);
        }

        // GET: PersonType/Details/5
        public async Task<ActionResult> Details(int id)
        {
            personT = new PersonType();
            responseClient = new Response();
            ...
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    if (responseClient.Success)
                    {
                        personT = JsonConvert.DeserializeObject<PersonType>(responseClient.Value.ToString());
                    }
                }
            }
            catch (Exception error)
        ...
        [HttpPost]
        public async Task<ActionResult> Create(PersonType collection)
        {
            try
            {
                responseClient = new Response();
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(int id, PersonType collection)
        {
            try
            {
                responseClient = new Response();
        ...
        [HttpPost]
        public async Task<ActionResult> Delete(int id, PersonType collection)
        {
            try
            {
                responseClient = new Response();
